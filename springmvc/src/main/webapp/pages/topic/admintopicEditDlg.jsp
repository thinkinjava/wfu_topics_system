...
$("#topicEditDlg_form").form({
	url :'<%=path%>/adminTopicController/updateTopic',
	onSubmit : function() {
...
<form id="topicEditDlg_form" method="post" class="aa">
	<table id="topicEditDlg_table" >
		<tr>
			<td>课题名称</td>
			<td>
		...
		<tr>
			...
			<td>
			    ...
			    <input  
                    ...
                    multiple:true,
                    panelHeight:'auto',
                    required:true,editable:false" style="width:350px"/>
			</td>
		</tr>
	</table>
</form>