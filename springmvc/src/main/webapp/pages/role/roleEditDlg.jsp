...
%>
<style>
#roleEditDlg_table{pEditing-left:20px;font-size: 12px;}
</style>
<script type="text/javascript">
	$(function(){
		/*form表单提交*/
		$("#roleEditDlg_form").form({
...
<form id="roleEditDlg_form" method="post">
<table id="roleEditDlg_table">
	<tr>
		<td>角色名</td>
		<td>
	...
	<tr>
		<td>排序</td>
		<td><input name="theorder" type="number" class="easyui-validatebox" data-options="required:true"/></td>
	</tr>
	<tr>
		<td>描述</td>
