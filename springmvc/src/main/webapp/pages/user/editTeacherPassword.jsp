...
<script type="text/javascript">
	$(function(){
		/*form表单提交*/
		$("#editTeacherPassWordDlg_form").form({
			url :'<%=path%>/userController/editTeacherPassWord',
			onSubmit : function() {
...
<form id="editTeacherPassWordDlg_form" method="post">
<input name="userName" type="hidden" />
<table id="editTeacherPassWordDlg_table">
	<tr>
		<td>新密码</td>
